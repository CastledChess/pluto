...
impl SimpleEval for Eval {
    ...
    fn simple_eval(&mut self, board: Board, turn: Color) -> i32 {
        ...
        return eval * if turn == Color::White { 1 } else { -1 };
    }
}

pub(crate) static WHITE_PIECE_SQUARE_TABLES: [[i32; 64]; 6] = [
    [
    ...
    [
        -20, -10, -10, -5, -5, -10, -10, -20, -10, 0, 0, 0, 0, 5, 0, -10, -10, 0, 5, 5, 5, 5, 5,
        -10, -5, 0, 5, 5, 5, 5, 0, 0, -5, 0, 5, 5, 5, 5, 0, -5, -10, 0, 5, 5, 5, 5, 0, -10, -10, 0,
        0, 0, 0, 0, 0, -10, -20, -10, -10, -5, -5, -10, -10, -20,
    ],
    [
        0, 30, 10, 0, 0, 10, 30, 20, 20, 20, 0, 0, 0, 0, 20, 20, -10, -20, -20, -20, -20, -20, -20,
...
pub(crate) static BLACK_PIECE_SQUARE_TABLES: [[i32; 64]; 6] = [
    [
